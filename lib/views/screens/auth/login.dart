...
import 'package:cari_teman/views/screens/main_screen.dart';
import 'package:cari_teman/views/widgets/custom_button.dart';
import 'package:cari_teman/views/widgets/custom_text_field.dart';
...
class _LoginState extends State<Login> {
  ...
  login() async {
    ...
    if (!form.validate()) {
      ...
      setState(() {});
      showInSnackBar(
          'Perbaikilah kesalahan-kesalahanmu sebelum kamu melakukanya.');
    } else {
